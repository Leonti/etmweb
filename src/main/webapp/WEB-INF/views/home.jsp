    ...
    <div class="container">
	    ...
	    <div class="row">
			...
			<div class="span8">
				...
				<p class="lead">
					Employee Time Management is a web service for employers that tracks time employees spend on their tasks by providing easy to use time tracking interface.
				</p>
				<h2>Who is it for?</h2>
